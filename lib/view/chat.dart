...
//         Uri.parse('$baseUrl/api/job-requests/${widget.jobRequestId}/accept/'),
...
//         });
//         print(
//           'Chat Room Details: $_chatRoomId, Driver: $_driverId, Job: $_jobId',
//         );
//       } else {
//         setState(() {
//           _errorMessage =
...
//     try {
//       final response = await http.get(
//         Uri.parse('$baseUrl/api/chat-history/$_chatRoomId/'),
//         headers: _getAuthHeaders(),
//       );
...
//     final bool isMe =
//         message['sender_id'] !=
//         _driverId; // Assuming current user is not the driver
