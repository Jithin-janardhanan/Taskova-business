...
//         await saveTokens(accessToken, refreshToken, googleUser.email, name);

//         // Check profile completion status
//         final profileStatusResponse = await http.get(
...
//         if (profileStatusResponse.statusCode == 200) {
//           final profileStatusData = jsonDecode(profileStatusResponse.body);
//           bool isProfileComplete =
//               profileStatusData['is_profile_complete'] ?? false;
...
//           }
//         } else {
//           // Handle profile status check failure
...
// import 'package:taskova/Model/api_config.dart';
// import 'package:taskova/Model/profile_status.dart';
// import 'package:taskova/auth/google.dart';
// import 'package:taskova/auth/profile_page.dart';
// import 'package:taskova/Model/colors.dart';
// import 'package:taskova/auth/forgot_password.dart';
// import 'package:taskova/language/language_selection_screen.dart';
...
//                       _socialLoginButton(
//                         onPressed: () {
//                           googleLogin(); // Call the refactored function
//                         },
//                         icon: Icons.g_mobiledata,
//                         label: appLanguage.get('google'),
//                         backgroundColor: Colors.white,
...
class _LoginState extends State<Login> {
  ...
  //   await _googleAuthService.signInWithGoogle(
  //     context: context,
  //     showSuccessSnackbar: (String _) {
  //       // Don't show success message, navigation will happen automatically
  //     },
  //     showErrorSnackbar: showErrorSnackbar,
  //     setLoadingState: (bool loading) {
  //       setState(() {
...
//         final prefs = await SharedPreferences.getInstance();
//         await prefs.setString('logged_in_email', account.email);
//         Navigator.of(context).pushReplacement(
//   MaterialPageRoute(builder: (_) => const HomePageWithBottomNav()),
// );

//       } else {
//         showErrorSnackbar(data['error'] ?? 'Google login failed');
//       }
//     } catch (e) {
//       showErrorSnackbar('Something went wrong during Google Sign-In');
//     }
//   }
