...
class AppColors {
  static const Color primaryBlue = Color(0xFF1E40AF);      // Deeper blue for primary actions
  static const Color secondaryBlue = Color(0xFF3B82F6);    // Original secondary blue
  static const Color lightBlue = Color(0xFFBFDBFE);        // Original light blue
